...
Endpoint = ${ENDPOINT}
AllowedIPs = 0.0.0.1/5, 8.0.0.0/7, 11.0.0.0/8, 12.0.0.0/6, 16.0.0.0/4, 32.0.0.0/3, 65.0.0.0/2, 128.0.0.0/1" >>"${HOME_DIR}/${SERVER_WG_NIC}-${SERVER_PUB_IP}-client-${CLIENT_NAME}.conf"
